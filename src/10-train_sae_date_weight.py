...
from datasets.market_dataset import SimpleMarketDatasetWithDateWeight
...
def main(cfg: TrainConfig):
    ...
    # Create loaders
    train_dataset = SimpleMarketDatasetWithDateWeight(
        df=train_df,
    ...
    valid_dataset = SimpleMarketDatasetWithDateWeight(
        df=valid_df,
        feature_cols=feature_cols,
        lag_cols=lag_cols,
        date_col=date_col,
